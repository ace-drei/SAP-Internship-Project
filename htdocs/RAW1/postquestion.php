            ...
            <section class="column-right">
                <div>
                    ...
                    <form action="insert_question.php" method="post">
                        ...
                        <br>
                        <textarea name="faqquestion" id="faqquestion" rows="2" cols="70">Post your answer here...</textarea>
                        <input type="submit" value="Submit Question">
                    </form>
                    <button onclick="submitAnswerForm()">Submit Answer</button>
                </div>
            </section>
        </div>
    </section>
...
<script>
    function submitQuestionForm() {
        document.getElementById("faqquestion").value = document.getElementById("faqquestion").value.trim();
        document.getElementById("faqquestion").value = (document.getElementById("faquestion").value === "Post your question here...") ? "" : document.getElementById("faqquestion").value;
        document.getElementById("faqquestion").value !== "" ? document.forms[0].submit() : alert("Please provide an question.");
    }
</script>
