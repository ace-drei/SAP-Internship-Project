            ...
            <section class="column-right">
                <div>
                    ...
                    <form action="insert_answer.php" method="post">
                        ...
                        <br>
                        <textarea name="faqanswer" id="faqanswer" rows="2" cols="70">Post your answer here...</textarea>
...
<script>
    function submitAnswerForm() {
        document.getElementById("faqanswer").value = document.getElementById("faqanswer").value.trim();
        document.getElementById("faqanswer").value = (document.getElementById("faqanswer").value === "Post your answer here...") ? "" : document.getElementById("faqanswer").value;
        document.getElementById("faqanswer").value !== "" ? document.forms[0].submit() : alert("Please provide an answer.");
    }
</script>
