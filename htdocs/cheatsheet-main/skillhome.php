...
<div>
                    ...
                    <?php
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    while ($row = $result->fetch_object()) {
                                        ...
                                        echo '<img src="data:image/jpeg;base64,' . base64_encode($img) . '" class="round-image" width="150px" height="150px"/>';
                                        echo '<p><strong>Name :</strong> ' . $fullName . '</p>';
                                        echo '<p><strong>Skill Sets :</strong> ' . $skillSets . '</p>';
                                        echo '</div>';
                        
                                        // Start a new row after every 3 profiles
                                        if ($profileCount % 3 == 2) { // Note: It's 4 because we start counting from 0
    ...
    <section class="column-right">
        <div> 
    <button onclick="Done()">Click to View Profile</button>
            <script>
                        function Done() 
                        {
                        window.location.href = "skillprofile.php?username=";
                        }
            </script>
